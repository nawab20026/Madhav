...
<body>
    <div class="qr-wrapper">
        <div class="qr-container text-center">
            ...
            <div class="qr-code">
                <img id='qrCode' style="display:none" src="<?php echo $qr_code_url; ?>" alt="QR Code" style="max-width: 100%;">
                <img id='qrCodes' src="<?php echo $qr_code_url; ?>" alt="QR Code" style="max-width: 100%;">
                
            </div>
            <div class="amount">Scan to pay ₹ <?php echo number_format($amount, 2); ?></div>
            <center><button class="pay-button" onclick="payViaUPI()">Download QR Code</button></center>
    ...
    img.onload = function() {
        ...
        canvas.toBlob(function(blob) {
            ...
            downloadLink.download = 'qr_code.png'; // Set the filename
...
function check() {
    $.ajax({
        type: 'post',
        url: 'https://5upi.gamekall.in/order3/payment-status',
